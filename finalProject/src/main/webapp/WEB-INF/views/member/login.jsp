...
<meta property="og:url" id="fbUrl" content="https://www.megabox.co.kr/booking?rpstMovieNo=22004700">
			...
			<form action="" method="post" name="myForm">
				...
				<div class="" align="left">
					<label class="form-check-lable">
						<input type="checkbox" name="rememberId" value="on" ${empty cookie.id.value ? "" : "checked" }>아이디 저장
				...
				<div class="" align="center">
					...
					<button type="button" onclick="location.replace('/movie/join')" class="btn btn-primary">회원가입</button>
				</div>
			</form>
		</div>
	</div>
